const calculateFirstPendulumAcceleration = (gravity, pendulum1, pendulum2)  => {
    const num_1 = -gravity * (2 * pendulum1.mass + pendulum2.mass) * sin(pendulum1.angle);
    const num_2 = -pendulum2.mass * gravity * sin(pendulum1.angle - 2 * pendulum2.angle);
...
const calculateSecondPendulumAcceleration = (gravity, pendulum1, pendulum2)  => {
